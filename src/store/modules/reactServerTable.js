/**
 * module
 * name        : reactServerTable
 * description : reactServerTable module
 * author      : lsj
 * created     : 18/9/18
 */
...
const ASYNC_STATUS_ITEM_PENDING = 'reactServerTable/ITEM_PENDING';
const ASYNC_STATUS_ITEM_ERROR = 'reactServerTable/ITEM_ERROR';
const ASYNC_STATUS_ITEM_SUCCESS =   'reactServerTable/ITEM_SUCCESS';

//async actionTypes for ITEMS
const ASYNC_STATUS_ITEMS_PENDING = 'reactServerTable/ITEMS_PENDING';
const ASYNC_STATUS_ITEMS_ERROR = 'reactServerTable/ITEMS_ERROR';
const ASYNC_STATUS_ITEMS_SUCCESS =  'reactServerTable/ITEMS_SUCCESS';

//async actionTypes for SUBMIT
const ASYNC_STATUS_SUBMIT_PENDING = 'reactServerTable/SUBMIT_PENDING';
const ASYNC_STATUS_SUBMIT_ERROR = 'reactServerTable/SUBMIT_ERROR';
const ASYNC_STATUS_SUBMIT_SUCCESS = 'reactServerTable/SUBMIT_SUCCESS';


//-------------------------------------------------------------------------------------
// 1-2) defines sync actionTypes required  : lsjAddActionSyncInModule
//-------------------------------------------------------------------------------------
// const CHANGE = 'reactServerTable/CHANGE';
const SET_MODE = 'reactServerTable/SET_MODE';
// const ADD_ITEM = 'reactServerTable/ADD_ITEM';
...
// - template string안에서 reactServerTableId를 $와 중괄호(curly bracket)안에 올바르게 넣으면, intellij의 FileTemplate parser가 자신의 변수로하게 인식해서
// file template을 이용하여 파일을 생성시 reactServerTableId의 기본값을 묻는다.. 따라서 아래에서는 그부분을 $}reactServerTableId{로 임시대체했슴
...
//-------------------------------------------------------------------------------------
export default function reactServerTable(state = initialState, action) {
