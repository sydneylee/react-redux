...
// const ASYNC_STATUS_SUCCESS_${module_name_in_all_upper} =   '${NAME}/SUCCESS_${module_name_in_all_upper}';
// const ASYNC_STATUS_SUCCESS_SUBMIT = '${NAME}/SUCCESS_SUBMIT';
// const ASYNC_STATUS_SUCCESS_${module_name_in_all_upper}_ITEMS =   'home/SUCCESS_${module_name_in_all_upper}_ITEMS';
...
// function get${module_name_in_upper}API(${NAME}Id){
//     //return axios.get(`http://jsonplaceholder.typicode.com/${NAME}s/$}${NAME}Id{`);
//     //return fetch(`http://jsonplaceholder.typicode.com/${NAME}s/$}${NAME}Id{`).then(function(response){return response.json()});
//
// }
// export const get${module_name_in_upper} = (${NAME}Id) => async (dispatch) => {
//
//     dispatch({ type: ASYNC_STATUS_LOADING });
//     try{
//         const response = await get${module_name_in_upper}API(${NAME}Id);
...
//         dispatch({type: ASYNC_STATUS_SUCCESS_${module_name_in_all_upper}_ITEMS, payload : response});
//         //return response;
//     }
//     catch(e){
//         dispatch({type:ASYNC_STATUS_ERROR, payload: e});
...
export const initialState ={
    ...
    // ${NAME}s :[{${NAME}Id:1, title:'aaaaa'},{${NAME}Id:2, title:'bbbbb'},{${NAME}Id:3, title:'ccccc'}],
...
export default function ${NAME}(state=initialState, action){
    ...
    switch(action.type){
        ...
        // case ASYNC_STATUS_SUCCESS_${module_name_in_all_upper}:
        //     return{
        //         ...state,
        //         loading:false,
        //         error : false,
        ...
        // };
        // case ASYNC_STATUS_SUCCESS_${module_name_in_all_upper}_ITEMS:
        //     return{
        //         ...state,
        //         loading:false,
        //         error : false,
