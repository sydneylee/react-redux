 ...
 * module
 * name        : namesPHS
 * description : names using PHS form validation + validator module
 * author      : lsj
 * created     : 13/9/18
 */
...
const ASYNC_STATUS_LOADING = 'namesPHS/LOADING';
const ASYNC_STATUS_ERROR = 'namesPHS/ERROR';
...
export default function namesPHS(state = initialState, action) {
