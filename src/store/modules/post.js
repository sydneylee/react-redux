...
//     return fetch('/api/postItems').then(function(response){return response.json()});
// }
//
...
//         dispatch({type: ASYNC_STATUS_SUCCESS_POST_ITEMS, payload : response});
//         //return response;
//     }
//     catch(e){
//         dispatch({type:ASYNC_STATUS_ERROR, payload: e});
...
export default function post(state = initialState, action) {
    ...
    switch (action.type) {
        ...
        // };
        // case ASYNC_STATUS_SUCCESS_POST_ITEMS:
        //     return{
        //         ...state,
        //         loading:false,
        //         error : false,
