 ...
 * module
 * name        : namesRFF
 * description : names using React-final-form
 * author      : lsj
 * created     : 12/9/18
 */
...
const ASYNC_STATUS_LOADING = 'namesRFF/LOADING';
const ASYNC_STATUS_ERROR = 'namesRFF/ERROR';

// 1-1) defines any async actionTypes required
// const ASYNC_STATUS_SUCCESS_POST =   'namesRFF/SUCCESS_POST';
 const ASYNC_STATUS_SUCCESS_SUBMIT = 'namesRFF/SUCCESS_SUBMIT';

// 1-2) defines any sync actionTypes required
const CHANGE = 'namesRFF/CHANGE';
...
export default function namesRFF(state = initialState, action) {
