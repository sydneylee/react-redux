 ...
 * module
 * name        : namesYUP
 * description : names using YUP for form validation
 * author      : lsj
 * created     : 12/9/18
 */
...
const ASYNC_STATUS_LOADING = 'namesYUP/LOADING';
const ASYNC_STATUS_ERROR = 'namesYUP/ERROR';

// 1-1) defines any async actionTypes required
// const ASYNC_STATUS_SUCCESS_POST =   'namesYUP/SUCCESS_POST';
 const ASYNC_STATUS_SUCCESS_SUBMIT = 'namesYUP/SUCCESS_SUBMIT';

// 1-2) defines any sync actionTypes required
const CHANGE = 'namesYUP/CHANGE';
...
export default function namesYUP(state = initialState, action) {
